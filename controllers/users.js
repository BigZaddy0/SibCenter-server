...
export const getUser = async (req, res) => {
    try {
        ...
        const formattedUser = arrayUser.map(
            ({ _id, firstName, lastName, phone, bio, occupation, location, profilePhoto, email, friends, linkedinUrl, twitterUrl, viewedProfile, impressions, otp }) => {
                return { _id, firstName, lastName, occupation, phone, bio, location, profilePhoto, email, friends, linkedinUrl, twitterUrl, viewedProfile, impressions, otp };
            }
        );
    ...
    try {
        ...
        if (singleUser) {
            formattedUser = singleUser.map(
                ({ _id, firstName, lastName, occupation, phone, bio, location, profilePhoto }) => {
                    return { _id, firstName, lastName, occupation, phone, bio, location, profilePhoto };
                }
            );
        }
